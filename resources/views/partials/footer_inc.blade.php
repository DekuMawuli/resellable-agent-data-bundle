              ...
              <h4 class="footer-heading d-flex align-items-center justify-content-between">
                ...
                <span class="d-md-none">
                  <svg class="icon icon-dropdown" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    viewBox="0 0 24 24" fill="none" stroke="#00234D" stroke-width="1"
          ...
          <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
            <div class="footer-widget-inner">
              ...
              <ul class="footer-menu list-unstyled mb-0 d-md-block">
                ...
                @if($telHref)
                  <li class="footer-menu-item"><a href="{{ $telHref }}">Call: {{ $appSetting->contact_number }}</a></li>
                @endif
                @if($whatsappHref)
                  <li class="footer-menu-item"><a href="{{ $whatsappHref }}" target="_blank" rel="noopener noreferrer">WhatsApp Support</a></li>
                @endif
                <li class="footer-menu-item"><a href="{{ route('pages.login') }}">Sign In</a></li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-xl-4 col-lg-5 col-md-6 col-12 footer-widget">
            <div class="footer-widget-inner">
              <h4 class="footer-logo">
                <a href="{{ route('pages.home') ?? '/' }}" aria-label="GloVans">
                  <img src="{{ asset('admin_assets/images/glovans-logo-dark.svg') }}" alt="GloVans logo" style="height: 30px; width: auto;">
                </a>
              </h4>
              <p class="footer-text mb-4">
                Fast, reliable data bundles for MTN, Telecel, and AirtelTigo. We deliver in lightspeed.
              </p>
  ...
  <div class="footer-bottom bg-5">
    <div class="container">
      <div class="footer-bottom-inner d-flex flex-wrap justify-content-md-between justify-content-center align-items-center">
        ...
        <p class="copyright footer-text">&copy;{{ date('Y') }} GloVans. All rights reserved.</p>
      </div>
    </div>
  </div>
</footer>
